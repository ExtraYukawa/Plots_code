...
#  QCD300toinf_ev = get_mcEventnumber(QCD300toinf_list)
  ...
  df_DY_tree = RDataFrame("Events",DY_list)
  df_DY_tree = df_DY_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_DY_tree = df_DY_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_DY_tree = df_DY_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WJet_tree = RDataFrame("Events",WJet_list)
  df_WJet_tree = df_WJet_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WJet_tree = df_WJet_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WJet_tree = df_WJet_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_osWW_tree = RDataFrame("Events",osWW_list)
  df_osWW_tree = df_osWW_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_osWW_tree = df_osWW_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_osWW_tree = df_osWW_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ssWW_tree = RDataFrame("Events",ssWW_list)
  df_ssWW_tree = df_ssWW_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ssWW_tree = df_ssWW_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ssWW_tree = df_ssWW_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WWdps_tree = RDataFrame("Events",WWdps_list)
  df_WWdps_tree = df_WWdps_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WWdps_tree = df_WWdps_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WWdps_tree = df_WWdps_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WZew_tree = RDataFrame("Events",WZew_list)
  df_WZew_tree = df_WZew_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WZew_tree = df_WZew_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WZew_tree = df_WZew_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WZqcd_tree = RDataFrame("Events",WZqcd_list)
  df_WZqcd_tree = df_WZqcd_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WZqcd_tree = df_WZqcd_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WZqcd_tree = df_WZqcd_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ZZ_tree = RDataFrame("Events",ZZ_list)
  df_ZZ_tree = df_ZZ_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ZZ_tree = df_ZZ_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ZZ_tree = df_ZZ_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ZG_tree = RDataFrame("Events",ZG_list)
  df_ZG_tree = df_ZG_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ZG_tree = df_ZG_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ZG_tree = df_ZG_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WWW_tree = RDataFrame("Events",WWW_list)
  df_WWW_tree = df_WWW_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WWW_tree = df_WWW_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WWW_tree = df_WWW_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WWZ_tree = RDataFrame("Events",WWZ_list)
  df_WWZ_tree = df_WWZ_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WWZ_tree = df_WWZ_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WWZ_tree = df_WWZ_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WZZ_tree = RDataFrame("Events",WZZ_list)
  df_WZZ_tree = df_WZZ_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WZZ_tree = df_WZZ_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WZZ_tree = df_WZZ_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ZZZ_tree = RDataFrame("Events",ZZZ_list)
  df_ZZZ_tree = df_ZZZ_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ZZZ_tree = df_ZZZ_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ZZZ_tree = df_ZZZ_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tsch_tree = RDataFrame("Events",tsch_list)
  df_tsch_tree = df_tsch_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tsch_tree = df_tsch_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tsch_tree = df_tsch_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_t_tch_tree = RDataFrame("Events",t_tch_list)
  df_t_tch_tree = df_t_tch_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_t_tch_tree = df_t_tch_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_t_tch_tree = df_t_tch_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tbar_tch_tree = RDataFrame("Events",tbar_tch_list)
  df_tbar_tch_tree = df_tbar_tch_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tbar_tch_tree = df_tbar_tch_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tbar_tch_tree = df_tbar_tch_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tW_tree = RDataFrame("Events",tW_list)
  df_tW_tree = df_tW_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tW_tree = df_tW_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tW_tree = df_tW_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tbarW_tree = RDataFrame("Events",tbarW_list)
  df_tbarW_tree = df_tbarW_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tbarW_tree = df_tbarW_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tbarW_tree = df_tbarW_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttWtoLNu_tree = RDataFrame("Events",ttWtoLNu_list)
  df_ttWtoLNu_tree = df_ttWtoLNu_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttWtoLNu_tree = df_ttWtoLNu_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttWtoLNu_tree = df_ttWtoLNu_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttWtoQQ_tree = RDataFrame("Events",ttWtoQQ_list)
  df_ttWtoQQ_tree = df_ttWtoQQ_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttWtoQQ_tree = df_ttWtoQQ_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttWtoQQ_tree = df_ttWtoQQ_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttZ_tree = RDataFrame("Events",ttZ_list)
  df_ttZ_tree = df_ttZ_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttZ_tree = df_ttZ_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttZ_tree = df_ttZ_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttZtoQQ_tree = RDataFrame("Events",ttZtoQQ_list)
  df_ttZtoQQ_tree = df_ttZtoQQ_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttZtoQQ_tree = df_ttZtoQQ_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttZtoQQ_tree = df_ttZtoQQ_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttH_tree = RDataFrame("Events",ttH_list)
  df_ttH_tree = df_ttH_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttH_tree = df_ttH_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttH_tree = df_ttH_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttWW_tree = RDataFrame("Events",ttWW_list)
  df_ttWW_tree = df_ttWW_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttWW_tree = df_ttWW_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttWW_tree = df_ttWW_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttWZ_tree = RDataFrame("Events",ttWZ_list)
  df_ttWZ_tree = df_ttWZ_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttWZ_tree = df_ttWZ_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttWZ_tree = df_ttWZ_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttZZ_tree = RDataFrame("Events",ttZZ_list)
  df_ttZZ_tree = df_ttZZ_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttZZ_tree = df_ttZZ_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttZZ_tree = df_ttZZ_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tzq_tree = RDataFrame("Events",tzq_list)
  df_tzq_tree = df_tzq_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tzq_tree = df_tzq_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tzq_tree = df_tzq_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttWH_tree = RDataFrame("Events",TTWH_list)
  df_ttWH_tree = df_ttWH_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttWH_tree = df_ttWH_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttWH_tree = df_ttWH_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttZH_tree = RDataFrame("Events",TTZH_list)
  df_ttZH_tree = df_ttZH_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttZH_tree = df_ttZH_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttZH_tree = df_ttZH_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tttJ_tree = RDataFrame("Events",TTTJ_list)
  df_tttJ_tree = df_tttJ_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tttJ_tree = df_tttJ_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tttJ_tree = df_tttJ_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tttW_tree = RDataFrame("Events",TTTW_list)
  df_tttW_tree = df_tttW_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tttW_tree = df_tttW_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tttW_tree = df_tttW_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tttt_tree = RDataFrame("Events",TTTT_list)
  df_tttt_tree = df_tttt_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tttt_tree = df_tttt_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tttt_tree = df_tttt_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
...
#  df_QCD50to80_tree = RDataFrame("Events",QCD50to80_list)
#  df_QCD50to80_tree = df_QCD50to80_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
#  df_QCD50to80_tree = df_QCD50to80_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
...
#
#  df_QCD80to120_tree = RDataFrame("Events",QCD80to120_list)
#  df_QCD80to120_tree = df_QCD80to120_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
#  df_QCD80to120_tree = df_QCD80to120_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
...
#
#  df_QCD120to170_tree = RDataFrame("Events",QCD120to170_list)
#  df_QCD120to170_tree = df_QCD120to170_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
#  df_QCD120to170_tree = df_QCD120to170_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
...
#
#  df_QCD170to300_tree = RDataFrame("Events",QCD170to300_list)
#  df_QCD170to300_tree = df_QCD170to300_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
#  df_QCD170to300_tree = df_QCD170to300_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
...
#
#  df_QCD300toinf_tree = RDataFrame("Events",QCD300toinf_list)
#  df_QCD300toinf_tree = df_QCD300toinf_tree.Define("trigger_SF","trigger_sf_ee(DY_l1_pt,DY_l2_pt,DY_l1_eta,DY_l2_eta)")
#  df_QCD300toinf_tree = df_QCD300toinf_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[DY_l1_id]*Electron_RECO_SF[DY_l2_id]*Electron_CutBased_TightID_SF[DY_l1_id]*Electron_CutBased_TightID_SF[DY_l2_id]*trigger_SF*genWeight/abs(genWeight)")
...
#    df_QCD300toinf_histos.append(df_QCD300toinf_histo)
  ...
  df_TTTo2L_tree = RDataFrame("Events",TTTo2L_list)
  df_TTTo2L_tree = df_TTTo2L_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_TTTo2L_tree = df_TTTo2L_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_TTTo2L_tree = df_TTTo2L_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_TTTo1L_tree = RDataFrame("Events",TTTo1L_list)
  df_TTTo1L_tree = df_TTTo1L_tree.Define("trigger_SF","trigger_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_TTTo1L_tree = df_TTTo1L_tree.Define("eeID_SF","eleID_sf_ee(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_TTTo1L_tree = df_TTTo1L_tree.Define("genweight","puWeight*PrefireWeight*eeID_SF*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_DoubleEle_tree = RDataFrame("Events", doubleEle_names)
  ...
  df_SingleEle_tree = RDataFrame("Events", singleEle_names)
