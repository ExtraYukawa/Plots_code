#==============
# Last used:
# python tt_ee_2016postAPV.py --era 2016postAPV --saveDir 2016postAPV_ee
#==============
...
def TTC_Analysis():
  ...
  df_DY_tree = df_DY_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WJet_tree = df_WJet_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_osWW_tree = df_osWW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ssWW_tree = df_ssWW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  for i in hists_name:
    df_osWW_histo = df_osWW_trigger.Histo1D((i,'',histos_bins[i],histos_bins_low[i],histos_bins_high[i]), i,'genweight')
    df_ssWW_histos.append(df_osWW_histo)
  ...
  df_WWdps_tree = df_WWdps_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  for i in hists_name:
    ...
    df_osWW_histo = df_osWW_trigger.Histo1D((i,'',histos_bins[i],histos_bins_low[i],histos_bins_high[i]), i,'genweight')
    df_WWdps_histos.append(df_osWW_histo)
  ...
  df_WZew_tree = df_WZew_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  for i in hists_name:
    ...
    df_osWW_histo = df_osWW_trigger.Histo1D((i,'',histos_bins[i],histos_bins_low[i],histos_bins_high[i]), i,'genweight')
    df_WZew_histos.append(df_osWW_histo)
  ...
  df_WZqcd_tree = df_WZqcd_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ZZ_tree = df_ZZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ZG_tree = df_ZG_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  for i in hists_name:
    ...
    df_osWW_histo = df_osWW_trigger.Histo1D((i,'',histos_bins[i],histos_bins_low[i],histos_bins_high[i]), i,'genweight')
    df_ZG_histos.append(df_osWW_histo)
  ...
  df_WWW_tree = df_WWW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WWZ_tree = df_WWZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WZZ_tree = df_WZZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ZZZ_tree = df_ZZZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tsch_tree = df_tsch_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_t_tch_tree = df_t_tch_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tbar_tch_tree = df_tbar_tch_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tW_tree = df_tW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tbarW_tree = df_tbarW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttWtoLNu_tree = df_ttWtoLNu_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttWtoQQ_tree = df_ttWtoQQ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttZ_tree = df_ttZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttZtoQQ_tree = df_ttZtoQQ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttH_tree = df_ttH_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttWW_tree = df_ttWW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttWZ_tree = df_ttWZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttZZ_tree = df_ttZZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tzq_tree = df_tzq_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttWH_tree = df_ttWH_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttZH_tree = df_ttZH_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tttJ_tree = df_tttJ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tttW_tree = df_tttW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  for i in hists_name:
    ...
    df_osWW_histo = df_osWW_trigger.Histo1D((i,'',histos_bins[i],histos_bins_low[i],histos_bins_high[i]), i,'genweight')
    df_tttW_histos.append(df_osWW_histo)
  ...
  df_tttt_tree = df_tttt_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_TTTo1L_tree = df_TTTo1L_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
