...
#  QCD300toinf_ev = get_mcEventnumber(QCD300toinf_list)
  ...
  filters="OPS_region==2 && OPS_2P0F && OPS_z_mass>20 && n_tight_jet>1 && n_bjet_DeepB>0 && (OPS_l1_pt>30 || OPS_l2_pt>30) && OPS_drll>0.3 && Flag_goodVertices && Flag_globalSuperTightHalo2016Filter && Flag_HBHENoiseFilter && Flag_HBHENoiseIsoFilter && Flag_EcalDeadCellTriggerPrimitiveFilter && Flag_BadPFMuonFilter && Flag_eeBadScFilter && Flag_ecalBadCalibFilter && nHad_tau==0"

  df_DY_tree = ROOT.RDataFrame("Events",DY_list)
  df_DY_tree = df_DY_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_DY_tree = df_DY_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WJet_tree = df_WJet_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WJet_tree = df_WJet_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_osWW_tree = df_osWW_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_osWW_tree = df_osWW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ssWW_tree = df_ssWW_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ssWW_tree = df_ssWW_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WWdps_tree = df_WWdps_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WWdps_tree = df_WWdps_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WZew_tree = df_WZew_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WZew_tree = df_WZew_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WZqcd_tree = df_WZqcd_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WZqcd_tree = df_WZqcd_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ZZ_tree = df_ZZ_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ZZ_tree = df_ZZ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ZG_tree = df_ZG_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ZG_tree = df_ZG_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WWW_tree = df_WWW_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WWW_tree = df_WWW_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WWZ_tree = df_WWZ_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WWZ_tree = df_WWZ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WZZ_tree = df_WZZ_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_WZZ_tree = df_WZZ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ZZZ_tree = df_ZZZ_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ZZZ_tree = df_ZZZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tsch_tree = df_tsch_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tsch_tree = df_tsch_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_t_tch_tree = df_t_tch_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_t_tch_tree = df_t_tch_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tbar_tch_tree = df_tbar_tch_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tbar_tch_tree = df_tbar_tch_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tW_tree = df_tW_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tW_tree = df_tW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tbarW_tree = df_tbarW_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tbarW_tree = df_tbarW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttWtoLNu_tree = df_ttWtoLNu_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttWtoLNu_tree = df_ttWtoLNu_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttWtoQQ_tree = df_ttWtoQQ_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttWtoQQ_tree = df_ttWtoQQ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttZ_tree = df_ttZ_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttZ_tree = df_ttZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttZtoQQ_tree = df_ttZtoQQ_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttZtoQQ_tree = df_ttZtoQQ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttH_tree = df_ttH_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttH_tree = df_ttH_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttWW_tree = df_ttWW_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttWW_tree = df_ttWW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttWZ_tree = df_ttWZ_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttWZ_tree = df_ttWZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttZZ_tree = df_ttZZ_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttZZ_tree = df_ttZZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tzq_tree = df_tzq_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tzq_tree = df_tzq_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttWH_tree = df_ttWH_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttWH_tree = df_ttWH_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttZH_tree = df_ttZH_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_ttZH_tree = df_ttZH_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tttJ_tree = df_tttJ_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tttJ_tree = df_tttJ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tttW_tree = df_tttW_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tttW_tree = df_tttW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tttt_tree = df_tttt_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_tttt_tree = df_tttt_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
...
#  df_QCD50to80_tree = df_QCD50to80_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
#  df_QCD50to80_tree = df_QCD50to80_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*trigger_SF*genWeight/abs(genWeight)")
...
#  df_QCD80to120_tree = df_QCD80to120_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
#  df_QCD80to120_tree = df_QCD80to120_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*trigger_SF*genWeight/abs(genWeight)")
...
#  df_QCD120to170_tree = df_QCD120to170_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
#  df_QCD120to170_tree = df_QCD120to170_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*trigger_SF*genWeight/abs(genWeight)")
...
#  df_QCD170to300_tree = df_QCD170to300_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
#  df_QCD170to300_tree = df_QCD170to300_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*trigger_SF*genWeight/abs(genWeight)")
...
#  df_QCD300toinf_tree = df_QCD300toinf_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
#  df_QCD300toinf_tree = df_QCD300toinf_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[OPS_l1_id]*Electron_RECO_SF[OPS_l2_id]*trigger_SF*genWeight/abs(genWeight)")
...
#    df_QCD300toinf_histos.append(df_QCD300toinf_histo)
  ...
  df_TTTo2L_tree = df_TTTo2L_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_TTTo2L_tree = df_TTTo2L_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_TTTo1L_tree = df_TTTo1L_tree.Define("trigger_SF","trigger_sf_em(OPS_l1_pt,OPS_l2_pt,OPS_l1_eta,OPS_l2_eta)")
  df_TTTo1L_tree = df_TTTo1L_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
