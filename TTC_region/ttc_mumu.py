...
#  QCD300toinf_ev = get_mcEventnumber(QCD300toinf_list)
  ...
  filters="ttc_jets && ttc_region==1 && ttc_l1_pt>30 && ttc_met>30 && ttc_mll>20 && ttc_drll>0.3 && Flag_goodVertices && Flag_globalSuperTightHalo2016Filter && Flag_HBHENoiseFilter && Flag_HBHENoiseIsoFilter && Flag_EcalDeadCellTriggerPrimitiveFilter && Flag_BadPFMuonFilter && Flag_eeBadScFilter && Flag_ecalBadCalibFilter && nHad_tau==0 && ttc_2P0F"
  ...
  df_WJet_tree = df_WJet_tree.Define("trigger_SF","trigger_sf_mm(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  ...
  df_tsch_tree = df_tsch_tree.Define("trigger_SF","trigger_sf_mm(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  ...
  df_t_tch_tree = df_t_tch_tree.Define("trigger_SF","trigger_sf_mm(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  ...
  df_tbar_tch_tree = df_tbar_tch_tree.Define("trigger_SF","trigger_sf_mm(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
...
#  df_QCD50to80_tree = df_QCD50to80_tree.Define("trigger_SF","trigger_sf_mm(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
#  df_QCD50to80_tree = df_QCD50to80_tree.Define("genweight","puWeight*PrefireWeight*genWeight/abs(genWeight)")
...
#  df_QCD80to120_tree = df_QCD80to120_tree.Define("trigger_SF","trigger_sf_mm(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
#  df_QCD80to120_tree = df_QCD80to120_tree.Define("genweight","puWeight*PrefireWeight*genWeight/abs(genWeight)")
...
#  df_QCD120to170_tree = df_QCD120to170_tree.Define("trigger_SF","trigger_sf_mm(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
#  df_QCD120to170_tree = df_QCD120to170_tree.Define("genweight","puWeight*PrefireWeight*genWeight/abs(genWeight)")
...
#  df_QCD170to300_tree = df_QCD170to300_tree.Define("trigger_SF","trigger_sf_mm(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
#  df_QCD170to300_tree = df_QCD170to300_tree.Define("genweight","puWeight*PrefireWeight*genWeight/abs(genWeight)")
...
#  df_QCD300toinf_tree = df_QCD300toinf_tree.Define("trigger_SF","trigger_sf_mm(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
#  df_QCD300toinf_tree = df_QCD300toinf_tree.Define("genweight","puWeight*PrefireWeight*genWeight/abs(genWeight)")
...
#    df_QCD300toinf_histos.append(df_QCD300toinf_histo)
  ...
  df_TTTo1L_tree = df_TTTo1L_tree.Define("trigger_SF","trigger_sf_mm(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
