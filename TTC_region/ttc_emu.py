...
def all_trigger(df):
  all_trigger = df.Filter("HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass8 || HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ || HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_Mass3p8 || HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ || HLT_Mu12_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ || HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL || HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ || HLT_IsoMu27 || HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL || HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ || HLT_passEle32WPTight || HLT_Ele35_WPTight_Gsf")
  return all_trigger
...
#  QCD300toinf_ev = get_mcEventnumber(QCD300toinf_list)
  ...
  df_DY_tree = df_DY_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WJet_tree = df_WJet_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_WJet_tree = df_WJet_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ssWW_tree = df_ssWW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WWdps_tree = df_WWdps_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WZew_tree = df_WZew_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WZqcd_tree = df_WZqcd_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ZZ_tree = df_ZZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ZG_tree = df_ZG_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[OPS_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WWW_tree = df_WWW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WWZ_tree = df_WWZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_WZZ_tree = df_WZZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ZZZ_tree = df_ZZZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tsch_tree = df_tsch_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_tsch_tree = df_tsch_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_t_tch_tree = df_t_tch_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_t_tch_tree = df_t_tch_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tbar_tch_tree = df_tbar_tch_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_tbar_tch_tree = df_tbar_tch_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tW_tree = df_tW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tbarW_tree = df_tbarW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttWtoLNu_tree = df_ttWtoLNu_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttWtoQQ_tree = df_ttWtoQQ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttZ_tree = df_ttZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttZtoQQ_tree = df_ttZtoQQ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttH_tree = df_ttH_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttWW_tree = df_ttWW_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttWZ_tree = df_ttWZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_ttZZ_tree = df_ttZZ_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_tzq_tree = df_tzq_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
...
#  df_QCD50to80_tree = df_QCD50to80_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
#  df_QCD50to80_tree = df_QCD50to80_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
...
#  df_QCD80to120_tree = df_QCD80to120_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
#  df_QCD80to120_tree = df_QCD80to120_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
...
#  df_QCD120to170_tree = df_QCD120to170_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
#  df_QCD120to170_tree = df_QCD120to170_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
...
#  df_QCD170to300_tree = df_QCD170to300_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
#  df_QCD170to300_tree = df_QCD170to300_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
...
#  df_QCD300toinf_tree = df_QCD300toinf_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
#  df_QCD300toinf_tree = df_QCD300toinf_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
...
#    df_QCD300toinf_histos.append(df_QCD300toinf_histo)
  ...
  df_TTTo2L_tree = df_TTTo2L_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_TTTo1L_tree = df_TTTo1L_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_TTTo1L_tree = df_TTTo1L_tree.Define("genweight","puWeight*PrefireWeight*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
...
#    histos.append(h_QCD300toinf.Clone())
    ...
    c1 = plot_TTCregion.draw_plots(histos, 1, hists_name[ij], 1)
    del histos[:]
