...
if __name__ == "__main__":
  ...
  parser.add_argument("--channels", dest = 'channels', default = ['ele', 'mu'], nargs = '+')
  ...
  for channel in args.channels:
    Generate_Histogram(args.era, args.indir, args.outdir, args.Labels, args.Black_list, args.logy, args.plot_ratio, args.unblind, args.signals, args.region, channel, args.only_signal,args.overflow, normalize = args.normalize)
