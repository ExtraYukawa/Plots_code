...
def makePlot(folder, hname, xmin, xmax, year="2018", isNorm=True):
    ...
    # sort the dict (NOT working yet)
    # h_sorted = {i: h_all[i] for i in sorted(h_all)}
    # print (h_sorted)
...
if __name__ == "__main__":
    ...
    # plottting
    makePlot("2017_mujets_20Sep2023T1457","DeepB_loose_j1_pt",30.0,200.0)
    makePlot("2017_mujets_20Sep2023T1457","DeepB_loose_j2_pt",30.0,200.0)
    makePlot("2017_mujets_20Sep2023T1457","DeepB_loose_j3_pt",30.0,200.0)
    makePlot("2017_mujets_20Sep2023T1457","DeepB_loose_j1_eta",-2.5,2.5)
    makePlot("2017_mujets_20Sep2023T1457","DeepB_loose_j2_eta",-2.5,2.5)
    makePlot("2017_mujets_20Sep2023T1457","DeepB_loose_j3_eta",-2.5,2.5)
