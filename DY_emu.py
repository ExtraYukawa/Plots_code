...
#  QCD300toinf_ev = get_mcEventnumber(QCD300toinf_list)
  ...
  filters="OPS_region==2 && OPS_2P0F && OPS_z_mass>60 && OPS_z_mass<120 && (OPS_l1_pt>30 || OPS_l2_pt>30) && OPS_drll>0.3 && Flag_goodVertices && Flag_globalSuperTightHalo2016Filter && Flag_HBHENoiseFilter && Flag_HBHENoiseIsoFilter && Flag_EcalDeadCellTriggerPrimitiveFilter && Flag_BadPFMuonFilter && Flag_eeBadScFilter && Flag_ecalBadCalibFilter && nHad_tau==0"
