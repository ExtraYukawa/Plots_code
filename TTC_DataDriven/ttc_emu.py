...
#  VBFHZZ4L_ev = get_mcEventnumber(VBFHZZ4L_list)
  ...
  df_DY_tree = df_DY_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_DY_tree = df_DY_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_DY_tree = df_Fake_DY_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_DY_tree = df_Fake_DY_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_osWW_tree = df_osWW_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_osWW_tree = df_osWW_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_osWW_tree = df_Fake_osWW_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_osWW_tree = df_Fake_osWW_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_ssWW_tree = df_ssWW_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_ssWW_tree = df_ssWW_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_ssWW_tree = df_Fake_ssWW_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_ssWW_tree = df_Fake_ssWW_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_WWdps_tree = df_WWdps_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_WWdps_tree = df_WWdps_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_WWdps_tree = df_Fake_WWdps_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_WWdps_tree = df_Fake_WWdps_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_WZew_tree = df_WZew_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_WZew_tree = df_WZew_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_WZew_tree = df_Fake_WZew_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_WZew_tree = df_Fake_WZew_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_WZqcd_tree = df_WZqcd_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_WZqcd_tree = df_WZqcd_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_WZqcd_tree = df_Fake_WZqcd_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_WZqcd_tree = df_Fake_WZqcd_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_ZZ_tree = df_ZZ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_ZZ_tree = df_ZZ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_ZZ_tree = df_Fake_ZZ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_ZZ_tree = df_Fake_ZZ_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_ZG_tree = df_ZG_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_ZG_tree = df_ZG_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_ZG_tree = df_Fake_ZG_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_ZG_tree = df_Fake_ZG_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_WWW_tree = df_WWW_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_WWW_tree = df_WWW_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_WWW_tree = df_Fake_WWW_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_WWW_tree = df_Fake_WWW_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_WWZ_tree = df_WWZ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_WWZ_tree = df_WWZ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_WWZ_tree = df_Fake_WWZ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_WWZ_tree = df_Fake_WWZ_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_WZZ_tree = df_WZZ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_WZZ_tree = df_WZZ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_WZZ_tree = df_Fake_WZZ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_WZZ_tree = df_Fake_WZZ_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_ZZZ_tree = df_ZZZ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_ZZZ_tree = df_ZZZ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_ZZZ_tree = df_Fake_ZZZ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_ZZZ_tree = df_Fake_ZZZ_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_tW_tree = df_tW_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_tW_tree = df_tW_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_tW_tree = df_Fake_tW_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_tW_tree = df_Fake_tW_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_tbarW_tree = df_tbarW_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_tbarW_tree = df_tbarW_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_tbarW_tree = df_Fake_tbarW_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_tbarW_tree = df_Fake_tbarW_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_ttWtoLNu_tree = df_ttWtoLNu_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_ttWtoLNu_tree = df_ttWtoLNu_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_ttWtoLNu_tree = df_Fake_ttWtoLNu_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_ttWtoLNu_tree = df_Fake_ttWtoLNu_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_ttWtoQQ_tree = df_ttWtoQQ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_ttWtoQQ_tree = df_ttWtoQQ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_ttWtoQQ_tree = df_Fake_ttWtoQQ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_ttWtoQQ_tree = df_Fake_ttWtoQQ_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_ttZ_tree = df_ttZ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_ttZ_tree = df_ttZ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_ttZ_tree = df_Fake_ttZ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_ttZ_tree = df_Fake_ttZ_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_ttZtoQQ_tree = df_ttZtoQQ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_ttZtoQQ_tree = df_ttZtoQQ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_ttZtoQQ_tree = df_Fake_ttZtoQQ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_ttZtoQQ_tree = df_Fake_ttZtoQQ_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_ttH_tree = df_ttH_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_ttH_tree = df_ttH_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_ttH_tree = df_Fake_ttH_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_ttH_tree = df_Fake_ttH_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_tttW_tree = df_tttW_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_tttW_tree = df_tttW_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_tttW_tree = df_Fake_tttW_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_tttW_tree = df_Fake_tttW_tree.Define("fakelep_weight","fakelepweight_ee_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_tttJ_tree = df_tttJ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_tttJ_tree = df_tttJ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_tttJ_tree = df_Fake_tttJ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_tttJ_tree = df_Fake_tttJ_tree.Define("fakelep_weight","fakelepweight_ee_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_ttG_tree = df_ttG_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_ttG_tree = df_ttG_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_ttG_tree = df_Fake_ttG_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_ttG_tree = df_Fake_ttG_tree.Define("fakelep_weight","fakelepweight_ee_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_ttWH_tree = df_ttWH_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_ttWH_tree = df_ttWH_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_ttWH_tree = df_Fake_ttWH_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_ttWH_tree = df_Fake_ttWH_tree.Define("fakelep_weight","fakelepweight_ee_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_ttZH_tree = df_ttZH_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_ttZH_tree = df_ttZH_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_ttZH_tree = df_Fake_ttZH_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_ttZH_tree = df_Fake_ttZH_tree.Define("fakelep_weight","fakelepweight_ee_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_tttt_tree = df_tttt_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_tttt_tree = df_tttt_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_tttt_tree = df_Fake_tttt_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_tttt_tree = df_Fake_tttt_tree.Define("fakelep_weight","fakelepweight_ee_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_ttWW_tree = df_ttWW_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_ttWW_tree = df_ttWW_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_ttWW_tree = df_Fake_ttWW_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_ttWW_tree = df_Fake_ttWW_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_ttWZ_tree = df_ttWZ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_ttWZ_tree = df_ttWZ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_ttWZ_tree = df_Fake_ttWZ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_ttWZ_tree = df_Fake_ttWZ_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_ttZZ_tree = df_ttZZ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_ttZZ_tree = df_ttZZ_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_ttZZ_tree = df_Fake_ttZZ_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_ttZZ_tree = df_Fake_ttZZ_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_tzq_tree = df_tzq_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_tzq_tree = df_tzq_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_tzq_tree = df_Fake_tzq_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_tzq_tree = df_Fake_tzq_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_TTTo2L_tree = df_TTTo2L_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_TTTo2L_tree = df_TTTo2L_tree.Define("genweight","puWeight*PrefireWeight*Muon_CutBased_LooseID_SF[ttc_l1_id]*Electron_RECO_SF[ttc_l2_id]*genWeight/abs(genWeight)")
  ...
  df_Fake_TTTo2L_tree = df_Fake_TTTo2L_tree.Define("trigger_SF","trigger_sf_em(ttc_l1_pt,ttc_l2_pt,ttc_l1_eta,ttc_l2_eta)")
  df_Fake_TTTo2L_tree = df_Fake_TTTo2L_tree.Define("fakelep_weight","fakelepweight_em_mc(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  ...
  df_MuonEle = df_MuonEle_tree.Filter(filters_data)
  ...
  df_FakeLep_SingleMu_tree = df_FakeLep_SingleMu_tree.Define("fakelep_weight","fakelepweight_em_data(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  df_FakeLep_SingleMu = df_FakeLep_SingleMu_tree.Filter(filters_data_fake)
  df_FakeLep_SingleMu_trigger = for_singlemuon_trigger_emuchannel(df_FakeLep_SingleMu)
  ...
  df_FakeLep_SingleEle_tree = df_FakeLep_SingleEle_tree.Define("fakelep_weight","fakelepweight_em_data(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  df_FakeLep_SingleEle = df_FakeLep_SingleEle_tree.Filter(filters_data_fake)
  df_FakeLep_SingleEle_trigger = for_singleele_trigger_emuchannel(df_FakeLep_SingleEle)
  ...
  df_FakeLep_MuonEle_tree = ROOT.RDataFrame("Events", muonEle_names)
  df_FakeLep_MuonEle_tree = df_FakeLep_MuonEle_tree.Define("fakelep_weight","fakelepweight_em_data(ttc_1P1F,ttc_0P2F,ttc_lep1_faketag,muon_conePt[ttc_l1_id],ttc_l1_eta,electron_conePt[ttc_l2_id],ttc_l2_eta)")
  df_FakeLep_MuonEle = df_FakeLep_MuonEle_tree.Filter(filters_data_fake)
  df_FakeLep_MuonEle_trigger = for_cross_trigger(df_FakeLep_MuonEle)
  df_FakeLep_MuonEle_histos=[]
  for i in hists_name:
    df_FakeLep_MuonEle_histo = df_FakeLep_MuonEle_trigger.Histo1D((i,'',histos_bins[i],histos_bins_low[i],histos_bins_high[i]), i, 'fakelep_weight')
    df_FakeLep_MuonEle_histos.append(df_FakeLep_MuonEle_histo)
  ...
  for ij in range(0,len(hists_name)):
    ...
    df_FakeLep_MuonEle_histos[ij].Draw()
...
#  ROOT.RDF.RunGraphs({df_ZZG_histo, df_ZZ_histo, df_ggZZ_4e_histo,df_ggZZ_4mu_histo, df_ggZZ_4tau_histo, df_ggZZ_2e2mu_histo,df_ggZZ_2e2tau_histo, df_ggZZ_2mu2tau_histo, df_TTZ_histo,df_TTG_histo, df_WWZ_histo, df_WZG_histo,df_WZZ_histo, df_ZZZ_histo, df_WZTo3L_histo,df_WZTo2L_histo, df_ZG_histo})
    ...
    h_fakelep_MuonEle = df_FakeLep_MuonEle_histos[ij].GetValue()
    ...
    c1 = plot.draw_plots(histos, 1, hists_name[ij], 1)
    del histos[:]
